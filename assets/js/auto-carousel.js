  ...
  carousels.forEach(function( carousel ) {
      ...
      if(carousel.getAttribute('duration')) {
        setInterval(function(){
          // 1. Detectamos si alguno de los menús está abierto
          // Buscamos los tres IDs que tienes en tu HTML
          const menuDemos = document.getElementById('nav_demos');
          const menuMarketing = document.getElementById('nav_marketing');
          const menuTecnologia = document.getElementById('nav_tecnologia');

          const anyMenuOpen = (menuDemos && menuDemos.style.display === 'block') ||
                              (menuMarketing && menuMarketing.style.display === 'block') ||
                              (menuTecnologia && menuTecnologia.style.display === 'block');

          // 2. Solo hacemos clic si el mouse no está encima,
          // no se ha interactuado Y ningún menú está abierto
          if (ele != document.querySelector(".auto-carousel:hover ul") &&
