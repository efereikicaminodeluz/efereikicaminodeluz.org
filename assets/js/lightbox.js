            ...
            if (xmlhttp.status == 200) {
                ...
                el.addEventListener("click", function(event) {
                    ...
                    document.getElementById('lightbox').innerHTML =
                        ...
                        '<iframe src="https://player.vimeo.com/video/' + el.getAttribute('data-id') + '/?autoplay=1&byline=0&title=0&portrait=0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>' +
                        '</div>' +
                        '</div>';
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var youtube_elements = document.querySelectorAll('a.lightbox-youtube');

    youtube_elements.forEach(element => {
    ...
    var image_elements = document.querySelectorAll('a.lightbox-image');
    ...
    image_elements.forEach(element => {
        ...
        element.addEventListener("click", function(event) {
            ...
            document.getElementById('lightbox').innerHTML =
                ...
                '<img src="' + this.getAttribute('href') + '" alt="" />' +
                '</div>';
